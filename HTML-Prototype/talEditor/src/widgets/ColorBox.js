define([
...
], function (declare, lang, on, _WidgetBase, _TemplatedMixin, ColorPicker, domConstruct, domStyle, domGeometry, template) {
    return declare([_WidgetBase, _TemplatedMixin], {
        ...
        postCreate: function () {
            ...
            this.own(on(this.swatchNode, 'click', lang.hitch(this, function () {
                this._showColorPicker();
            })));
            this.own(on(this.textbox, "blur", lang.hitch(this, function () {
                this.set("value", this.textbox.value);
            })));

            this.own(on(this.domNode, "mouseenter", lang.hitch(this, function (e) {
                this.focusing = true;
            })));
            this.own(on(this.domNode, "mouseleave", lang.hitch(this, function (e) {
                this.focusing = false;
            })));
            this.own(on(document, "click", lang.hitch(this, function (e) {
        ...
        _initColorPicker: function () {
            ...
            this.own(this.colorPickerRef.on("change", lang.hitch(this, function (color) {
                this._updateColor(color);
            })));

            this.own(on(this.colorPickerRef.domNode, "mouseenter", lang.hitch(this, function (e) {
                this.focusing = true;
            })));
            this.own(on(this.colorPickerRef.domNode, "mouseleave", lang.hitch(this, function (e) {
                this.focusing = false;
            })));
        },
